...
<head lang="pt-br">
  <title>RadioEscape | Criar conta</title>
  <meta charset="utf-8">
...
<body>
  <div class="container">
    ...
    <div class="form">
      ...
      <div class="container-fluid">
        <form name="frmUsuario" action="../model/insert_new_user.php" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
          ...
          <div class="passwordTextField">
            <input name="password" type="password" class="form-control" aria-describedby="passwordHelpBlock" placeholder="Senha" required minlength="8" maxlength="15">
      ...
      <a href="../index.php" class="criar">Fazer login</a>
    </div>
  </div>
